    ...
    <>
      ...
      <DropdownMenu modal={false}>
        ...
        >
          ...
          <div>
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 h-9 border-none shadow-none"
                value={searchQuery}
                  ...
                  {filteredThemes.map((theme) => {
                    ...
                    return (
                      <div
                        ...
                        className={`rounded-lg cursor-pointer transition-all duration-200 hover:shadow-md overflow-hidden border ${
                          isSelected
                      ...
                      >
                        ...
                        {"error" in theme && theme.error && (
                          <div className="text-xs text-destructive p-3 pt-2">
                            {theme.error}
                          </div>
                        )}
                      </div>
          ...
          <div className="p-2 flex items-center text-sm text-muted-foreground gap-1 justify-center">
            Get more themes at
            <a
